...
use crate::provider_clients::{antigravity, claude, codex, copilot, zai};
use crate::secrets;
...
const PROVIDER_SPECS: [ProviderSpec; 5] = [
    ProviderSpec {
        id: "antigravity",
        name: "Antigravity",
        icon_url: "/providers/antigravity.svg",
        brand_color: "#4285F4",
        lines: &ANTIGRAVITY_LINES,
        primary_candidates: &[
            "Gemini 3 Pro",
            "Gemini 3 Flash",
            "Claude Opus 4.5",
...
pub async fn probe_provider(
    ...
    for account in accounts {
        ...
        let result = match provider_id {
            "antigravity" => probe_antigravity(credentials).await,
...
async fn probe_antigravity(credentials: serde_json::Value) -> Result<ProbeSuccess> {
